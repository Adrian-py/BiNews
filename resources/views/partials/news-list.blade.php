    ...
    @foreach ($news_list as $news)
        <div>
            ...
            <div class="px-[5.26%] py-[1rem] flex flex-col gap-[1rem]">
                ...
                <form action="/likes/{{ $news->slug }}" method="POST" class="w-fit text-white-100 bg-neutrals-25 rounded-lg">
                    @csrf
                    <button class="w-full h-full px-[1.25rem] py-[0.25rem] flex items-center gap-[0.75rem]" type="submit" onclick="handleLike">
